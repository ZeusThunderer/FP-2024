(ns euler26.core-test
  (:require [clojure.test :refer [deftest is testing]]
            [euler26.core :refer [recurring-cycle-length recurring-for recurring-iterator recurring-map recurring-modular recurring-recursion recurring-tail-recursion]]))
